...
describe('EndpointManager', () => {
	...
	before(() => {
		...
		const existingPaths = [
			'c:/Users/TestUser/workspace1/index.html',
			'c:/Users/TestUser/workspace1/pages/page1.html',
			'/home/TestUser/workspace1/index.html',
			'/home/TestUser/workspace1/pages/page1.html',
			'//other/TestUser/workspace1/index.html',
			'//other/TestUser/workspace1/pages/page1.html',
	...
	it('returns the identical path for windows when encoding the path', async () => {
		const endpoint = await endpointManager.encodeLooseFileEndpoint(
			'c:/Users/TestUser/workspace1/index.html'
		);
	...
	it('returns an unsaved path for files that do not exist yet when encoding the path', async () => {
		const endpoint = await endpointManager.encodeLooseFileEndpoint(
			'c:/Users/TestUser/workspace1/dex.html'
		);
	...
	it('decodes the windows endpoint correctly', async () => {
		const file1 = await endpointManager.decodeLooseFileEndpoint(
			'/c:/Users/TestUser/workspace1/index.html'
		);
		assert.strictEqual(file1, 'c:/Users/TestUser/workspace1/index.html');

		const file2 = await endpointManager.decodeLooseFileEndpoint(
			'/c:/Users/TestUser/workspace1/pages/page1.html'
		);
	...
	it('decodes the UNC endpoint correctly', async () => {
		const file1 = await endpointManager.decodeLooseFileEndpoint(
			'/unc/other/TestUser/workspace1/index.html'
		);
		assert.strictEqual(file1, '//other/TestUser/workspace1/index.html');

		const file2 = await endpointManager.decodeLooseFileEndpoint(
			'/unc/other/TestUser/workspace1/pages/page1.html'
		);
	...
	it('refuses to decode invalid paths', async () => {
		...
		const file3 = await endpointManager.decodeLooseFileEndpoint(
			'/c:/Users/TestUser/workspace1/fake.html'
		); // does not exist
